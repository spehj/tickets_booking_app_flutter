          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.only(
                  left: AppLayout.getWidth(16), top: AppLayout.getHeight(10), right: AppLayout.getWidth(16), bottom: AppLayout.getHeight(10)),
              child: Column(
                children: [
                  Row(
                    children: [
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                          ...
                          children: [
                            Text(ticket["date"], style: Styles.headlineStyle3.copyWith(
                                color: Colors.white),),
                            SizedBox(height: AppLayout.getHeight(5),),
                            Text("DATE", style: Styles.headlineStyle4.copyWith(
                                color: Colors.white),),
                          ]),
                      Column(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Text(ticket["departure_time"], style: Styles.headlineStyle3
                                .copyWith(color: Colors.white),),
                            SizedBox(height: AppLayout.getHeight(5),),
                      ...
                      Column(
                          ...
                          children: [
                            Text(ticket["number"].toString(), style: Styles.headlineStyle3.copyWith(
                                color: Colors.white),),
                            SizedBox(height: AppLayout.getHeight(5),),
                            Text("Gate", style: Styles.headlineStyle4.copyWith(
                                color: Colors.white),),
                          ]),
